...
const chocoData = {
    'snickers': {
        ...
        text: "जब भी आप गुस्से में 'Hangry' (Hungry + Angry) हो जाओगी, मैं हमेशा Snickers Crunchy के साथ आपकी प्यारी सी स्माइल वापस लाने का प्रॉमिस करता हूँ! 🍫"
    },
    'dairymilk': {
    ...
    'kitkat': {
        ...
        text: "दुनिया की सारी टेंशन और थकान से दूर, मैं हमेशा आपका सुकून वाला 'Break' बनूँगा। Have a break, have me! ❤️"
    },
    'chocopie': {
        title: "Choco Pie Promise 🧁",
        text: "मैं प्रॉमिस करता हूँ कि आपके इस Choco Pie जैसे सॉफ्ट और प्यारे दिल को हमेशा खुशियों से भरकर रखूँगा और कभी टूटने नहीं दूँगा।"
    },
    'kinderjoy': {
        title: "Kinder Joy Promise 🥚",
        text: "मैं वादा करता हूँ कि आपके अंदर की उस छोटी सी, चुलबुली बच्ची को हमेशा ज़िंदा रखूँगा। You are and will always be my Kinder Joy! 💖"
    }
};
